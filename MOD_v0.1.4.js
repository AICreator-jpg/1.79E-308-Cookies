    ...
    var FtHoFPlanner = {
        ...
        updateOptionsMenu: function () {
            ...
            for (var highlightEffect in this.highlightSettings) {
                ...
                highlightNext[highlightEffect] = null;

                for (var highlightIndex = 0; highlightIndex < forecasts.length; highlightIndex++) {
                    if (forecasts[highlightIndex].forecast.result === highlightEffect) {
                        highlightNext[highlightEffect] = forecasts[highlightIndex].hand;
                        break;
                    }
                }
            }
            ...
            for (
                ...
                var effectHighlightStyle =
                    this.highlightSettings[f.result] ?
                        'background:#fff59d;font-weight:bold;' :
                        '';
                ...
                rowsHTML +=
                    '<tr style="cursor:pointer;" data-fthof-row="' + i + '">' +
                        ...
                        '</td>' +
                        '<td style="padding:5px 7px;' + effectHighlightStyle + '">' +
                            '<b>' + displayEffect + '</b>' +
                        '</td>' +
                    '</tr>' +
                    ...
                    '<div id="FtHoFPlannerHighlightBody" style="margin-top:8px;">' +
                        ...
                        (function () {
                            ...
                            for (var highlightIndex = 0; highlightIndex < effects.length; highlightIndex++) {
                                ...
                                var nextText =
                                    highlightNext[effect] !== null &&
                                    highlightNext[effect] !== undefined ?
                                        highlightNext[effect] + '手目' :
                                        '10手以内なし';
