          ...
          function setupPantheonTouch() {
            try {
              ...
              function setGod(slot) {
                ...
                M.dragGod(M.gods[M.godSelected]);
              ...
              // タッチ操作ではclickだけに頼らず、touchendでも同じ処理を実行する
              // touchend後にブラウザが発生させるclickの二重実行は無視する
              function bindTouchAction(el, action) {
              ...
              for (var i = 0; i < M.gods.length; i++) {
                (function(g) {
                  ...
                  bindTouchAction(godEl, function(e) {
                    if (e && e.stopPropagation) e.stopPropagation();
              ...
              for (var s = 0; s < M.slot.length; s++) {
                (function(slotIndex) {
                  ...
                  bindTouchAction(slotEl, function(e) {
                    if (e && e.stopPropagation) e.stopPropagation();
              ...
              bindTouchAction(godsArea, function(e) {
                if (e && e.stopPropagation) e.stopPropagation();
