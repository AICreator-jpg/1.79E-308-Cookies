            ...
            for (
                ...
                rowsHTML +=
                    '<tr style="cursor:pointer;" data-fthof-row="' + i + '">' +
                        ...
                        '</td>' +
                        '<td style="padding:5px 7px;' + season1HighlightStyle + season1ColorStyle + '">' +
                            '<b>' + season1Effect + '</b>' +
                        '</td>' +
                        '<td style="padding:5px 7px;' + season2HighlightStyle + season2ColorStyle + '">' +
                            '<b>' + season2Effect + '</b>' +
                        '</td>' +
                    '</tr>' +
                        ...
                        '<table style="width:100%;border-collapse:collapse;font-size:13px;">' +
                            '<thead>' +
                                '<tr>' +
                                    ...
                                    '<th style="text-align:left;padding:5px 7px;">シーズン1</th>' +
                                    '<th style="text-align:left;padding:5px 7px;">シーズン2</th>' +
                                '</tr>' +
                            '</thead>' +
                            '<tbody>' +
                                rowsHTML +
